<div class="row align-items-center mt-2">
    <div class="col">
        <ul class="breadcrumb d-flex align-items-center mb-0">
            ...
            <li><a href="{{ route('p1prod') }}">P1 Production</a></li>
            <li><a href="{{ route('p2') }}">P2 Production</a></li>
            <li><a href="{{ route('p3') }}">P3 Production</a></li>
            <li><a href="{{ route('p5') }}">P5 Production</a></li>
            <li><a href="{{ route('p6') }}">P6 Production</a></li>
        </ul>
    </div>
</div>
